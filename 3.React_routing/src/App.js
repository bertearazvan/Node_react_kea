        ...
        <div className='App' style={{ backgroundColor }}>
          ...
          <Switch>
            ...
            <Route
              path='/form'
              component={props => (
                <Form {...props} handleNameChange={this.onNameChange} />
              )}></Route>
            <Route
              path='/theme'
              component={props => (
                <Theme {...props} handleThemeChange={this.onThemeChange} />
              )}></Route>
            <Route
              path='/about'
              component={props => <About {...props} />}></Route>
            <Route
              path='/cities'
              component={props => <Cities {...props} />}></Route>
          </Switch>
        </div>
      </Router>
    );
